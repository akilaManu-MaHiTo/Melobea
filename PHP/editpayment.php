    ...
    <body>
		...
		<table width="100%"; border="1">
				...
				<?php
					...
					$sql="SELECT p.payID,p.cardtype,p.cdName,p.Shipment,n.bname,n.bprice
                            FROM payment p
					...
					while($row=$result->fetch_assoc()){	
							echo"<tr>
									...
									<td><a href='editpaymentdb.php?payID=$row[payID]&bname=$row[bname]&bprice=$row[bprice]&cardtype=$row[cardtype]&cdName=$row[cdName]&Shipment=$row[Shipment]'>🖊️</a></td>
									<td><a href='deletepament.php?payID=$row[payID]'>❌</a></td>
								</tr>";
						}
					}
				?>
