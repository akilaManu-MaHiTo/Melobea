...
<html lang="en">
    <head>
        ...
        <!--Style Sheet-->
            <link rel="stylesheet" href="Style/N_store.css">
        <!-- End Style Sheet-->
    ...
    <div class="cat" id="categoryListWrapper">
        ...
        <?php
            ...
            $sql = "SELECT bname, bbrand, bcondition, bprice, bcountry, bimage, bdep FROM newitem";
                ...
                <div class="popup1">
                    ...
                    <div class="form">
                        ...
                        <div class="form-Element">
			                ...
			                <input type="password" id="pwd" required name="Repassword">
