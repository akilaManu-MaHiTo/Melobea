...
<form action="submiteditUitems.php" method="POST">
...
<div class="input-container">
    <label for="category">Item Brand:</label>
...
<div class="input-container">
    ...
    <input type="text" value="<?php echo $prc; ?>" name="price">
</div>
...
<div class="input-container">
    ...
    <input type="text" value="<?php echo $con; ?>" name="country">
</div>
