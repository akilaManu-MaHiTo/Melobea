				...
				<?php
					...
					while($row=$result->fetch_assoc()){	
							echo"<tr>
									...
									<td>".$row["bdep"]."</td>
									<td>".$row["bimage"]."</td>
									<td><a href='edititemdb.php?code=$row[bcode]&category=$row[bcategory]&name=$row[bname]&brand=$row[bbrand]&country=$row[bcountry]&price=$row[bprice]&condition=$row[bcondition]&dep=$row[bdep]&img=$row[bimage]'>🖊️</a></td>
									<td><a href='deletenewitem.php?code=$row[bcode]'>❌</a></td>
								</tr>";
						}
					}
				?>
