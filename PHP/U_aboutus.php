...
<html lang="en">
    <head>
        ...
        <!--Style Sheet-->
            <link rel="stylesheet" href="Style/U_aboutus.css">
        <!-- End Style Sheet-->
        ...
        <div class="logpos">
            ...
            <button id="dec1"><a href="U_account.php"><i class="fas fa-user"></i></a></button>
                ...
                <div class=myabt>
                    <section id="about us">
                        <h1>About Us</h1>
                        <p class="abt">"Welcome to MELOBEA Store,where music meets passion!<br>
                        We are a team of music enthusiasts dedicated to providing high-quality instruments and accessories to musicians of all levels.
                        </p>
            
                        <h2>Our Story</h2>
            
                        <p>At Melobea Page, we believe in the transformative power of music. Our journey began with a shared passion for music and a deep commitment to making exceptional instruments and accessories accessible to musicians of all backgrounds.</p>
            
                        <h3>We value:</h3>
            
                        <p>Quality: We meticulously curate our collection to offer products that meet the highest standards of craftsmanship and performance.<br>
                        Music has the power to unite people, and we are proud to be a part of the global music community. We foster connections among musicians and support their creative journeys.</p>
                        <br><br>
                        <h2>Mission</h2>
                           
                        <p>At Melobea Page, our mission is to empower musicians of all levels to pursue their passion for music by providing them with high-quality instruments and accessories that inspire creativity, elevate performance, and make music more accessible.</p>
                        
                        <h2>Customer-Centric Approach</h2>
            
                        <p>At MELOBEA Store, we are dedicated to providing exceptional customer service. Our 100% satisfaction guarantee ensures that you'll be delighted with your purchase, or we'll make it right.</p>
            
                        <h2>Highlight Our Expertise</h2>
            
                        <p>At Melobea Page, our team is driven by a deep passion for music, and we've immersed ourselves in the world of music instruments and accessories for years. Our expertise is the cornerstone of what sets us apart in the industry.</p>
