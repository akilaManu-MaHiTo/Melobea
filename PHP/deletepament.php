...
<?php
    ...
    // Delete related rows from the refund table
    $refundDeleteSql = "DELETE FROM refund WHERE payID = '$payID'";
    if (mysqli_query($mysqli, $refundDeleteSql)) {
        // Now you can delete the row from the payment table
        $paymentDeleteSql = "DELETE FROM payment WHERE payID = '$payID'";
        if (mysqli_query($mysqli, $paymentDeleteSql)) {
        ...
        echo "Error deleting related refunds: " . $mysqli->error;
    }
