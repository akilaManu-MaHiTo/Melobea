...
<html lang="en">
    ...
    <body>
		...
		?>
		<form action="submitedititem.php" method="POST">

			<div class="input-container">
				<label for="code">Item Code:</label>
				<input type="text" value="<?php echo $coding; ?>" name="code" readonly>
			</div>

			<div class="input-container">
				<label for="category">Item category:</label>
				<input type="text" value="<?php echo $catego; ?>" name="category">
			</div>

			<div class="input-container">
				<label for="name">Item name:</label>
				<input type="text" value="<?php echo $naam; ?>" name="name">
			</div>

			<div class="input-container">
				<label for="name">Item brand:</label>
				<input type="text" value="<?php echo $label; ?>" name="brand">
			</div>

			<div class="input-container">
				<label for="name">Item country:</label>
				<input type="text" value="<?php echo $state; ?>" name="country">
			</div>

			<div class="input-container">
				<label for="name">Item price:</label>
				<input type="text" value="<?php echo $cost; ?>" name="price">
			</div>

			<div class="input-container">
				<label for="name">Item condition:</label>
				<input type="text" value="<?php echo $condi; ?>" name="condition">
			</div>

			<div class="input-container">
				<label for="name">Item description:</label>
				<input type="text" value="<?php echo $des; ?>" name="dep">
			</div>

			<div class="input-container">
				<label for="name">Item image:</label>
				<input type="text" value="<?php echo $picture; ?>" name="img">
			</div>
