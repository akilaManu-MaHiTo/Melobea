<html lang="en">
    <head>
        ...
        <!--Style Sheet-->
            <link rel="stylesheet" href="Style/U_seller.css">
        <!-- End Style Sheet-->
    ...
    <div class="cat" id="categoryListWrapper">
		...
		<div class="sellform">
            <form action="addused.php" method="POST">

                <label class="label"> <b>Brand</b> </label><br>
                <input type="text" id="brand" name="usedbrand" required>
                <pre></pre>
                
                <label class="label"> <b>Item Type</b> </label><br>
                <input type="text" id="brand" name="usedtype" required>
                <pre></pre>
                
                <label class="label"><b> Description</b></label><br>
                <input type="text" id="brand" name="useddes" required>
                <pre></pre>
                
                <label class="label"><b>Price</b></label><br>
                <input type="text" id="brand" name="usedprice" required>		
                <pre></pre>
                
                <label class="label"><b>Item By Date:</b> </label><br>
                <input type="date" id="brand" name="useddate" required>
                <pre></pre>
    
                <label class="label"><b>Country: </b></label><br>
                <input type="text" id="brand" name="usedct" required><br>
                <pre></pre>
