...
<html lang="en">
    ...
    <body>
		...
		?>
		<form action="editshipmentdb.php" method="POST">

			<div class="input-container">
				<label for="code">Payment code:</label>
				<input type="text" value="<?php echo $payID; ?>" name="payID" readonly>
			</div>

			<div class="input-container">
				<label for="category">Item name:</label>
				<input type="text" value="<?php echo $bname; ?>" name="bname"readonly>
			</div>

			<div class="input-container">
				<label for="name">Item price:</label>
				<input type="text" value="<?php echo $bprice; ?>" name="bprice"readonly>
			</div>

			<div class="input-container">
				<label for="name">Card type:</label>
				<input type="text" value="<?php echo $cardtype; ?>" name="cardtype"readonly>
			</div>

			<div class="input-container">
				<label for="name">holdername:</label>
				<input type="text" value="<?php echo $cdName; ?>" name="cdName"readonly>
			</div>

			<div class="input-container">
				<label for="name">Shipment:</label>
				<input type="text" value="<?php echo $Shipment; ?>" name="Shipment">
			</div>
