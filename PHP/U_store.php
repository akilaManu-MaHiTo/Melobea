<html lang="en">
    ...
    <a href="U_store.php"><img src="Source/melobea logo.png"></a>
        ...
        <div class="navi">
        <ul>
            <li><a href="#">Brand New Items</a></li>
            <li><a href="U_useditem.php">Used Items</a></li>
    ...
    <div class="cat" id="categoryListWrapper">
        ...
        <?php
            ...
            $sql = "SELECT bcode,bname, bbrand, bcondition, bprice, bcountry, bimage, bdep FROM newitem";
                                ...
                                <div class="store">
                                    <div class="card">
                                        ...
                                        <div class="box">
                                            ...
                                            <a href="U_payment.php?bname=' . urlencode($bname) . '&bbrand=' . urlencode($bbrand) . '&bcondition=' . urlencode($bcondition) . '&bprice=' . urlencode($bprice) . '&bcountry=' . urlencode($bcountry) . '&bimage=' . urlencode($bimage) . '&bdep=' . urlencode($bdep). '&code=' . urlencode($code).'">
